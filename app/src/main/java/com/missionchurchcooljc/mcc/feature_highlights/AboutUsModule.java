...
public class AboutUsModule {
    ...
    @Provides
    public AboutUsMVP.Presenter provideAboutUsPresenter() {
        return new AboutUsPresenter(new AboutUsModel());
    }

    @Provides
    public AboutUsMVP.Model provideAboutUsModel() {
    ...
    //    @ActivityScope
    @Provides
    public DummyDependency provideDummyDependency(Context context) {
