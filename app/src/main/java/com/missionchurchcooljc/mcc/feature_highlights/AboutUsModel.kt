...
class AboutUsModel : AboutUsMVP.Model {
    ...
    interface OnPostsFetched {

//        void onPostItemsFetched(List<WebsiteHighlight> highlights);
//
//        void onPostItemFetched(WebsiteHighlight highlight);
//
//        void onError(String message);
    ...
    override fun fetchPosts(onPostsFetched: OnPostsFetched?) {
//        highlights = websiteRepository.getHighlightsAsList();
    }
}
